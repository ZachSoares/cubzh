        ...
        if (rtree_query_overlap_box(r,
            ...
            while (hit != NULL) {
                ...
                if (mode == RigidbodyMode_Dynamic) {
                    ...
                    Matrix4x4 invModel; transform_utils_get_model_wtl(hitLeaf, &invModel);
...
void _rigidbody_trigger_tick(Scene *scene,
    ...
    if (rtree_query_overlap_box(r,
        ...
        Matrix4x4 selfModel; transform_utils_get_model_ltw(t, &selfModel);
        Matrix4x4 selfInvModel; transform_utils_get_model_wtl(t, &selfInvModel);
        ...
        while (hit != NULL) {
            ...
            Box hitCollider = hitPerBlock ? shape_get_model_aabb(hitShape)
                                          : *rigidbody_get_collider(hitRb);
            Matrix4x4 hitModel; transform_utils_get_model_ltw(hitLeaf, &hitModel);
            Matrix4x4 hitInvModel; transform_utils_get_model_wtl(hitLeaf, &hitInvModel);
